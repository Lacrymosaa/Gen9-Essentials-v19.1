class PokeBattle_Scene
  ...
  def pbInitSprites
    ...
    msgWindow.z              = 200
    msgWindow.opacity        = 0
    msgWindow.baseColor      = PokeBattle_SceneConstants::MESSAGE_BASE_COLOR_WHITE
    msgWindow.shadowColor    = PokeBattle_SceneConstants::MESSAGE_SHADOW_COLOR_NEGRO
  ...
  def pbCreateBackdropSprites
    ...
    if @battle.backdropBase
      #baseFilename = sprintf("%s_%s",baseFilename,@battle.backdropBase)
    end
