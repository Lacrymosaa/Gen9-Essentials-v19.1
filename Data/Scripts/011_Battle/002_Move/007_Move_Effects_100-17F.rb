...
#===============================================================================
# Starts hail weather. (Hail, Snowscape)
#===============================================================================
class PokeBattle_Move_102 < PokeBattle_WeatherMove
  def initialize(battle,move)
    super
    @weatherType = :Hail #Its a lie, this is Snow
  end
end
...
#===============================================================================
# Userse but shadow move, not loosing hp on user
#===============================================================================
class PokeBattle_Move_10D2 < PokeBattle_Move
  def ignoresSubstitute?(user); return true; end

  def pbEffectAgainstTarget(user,target)
    @battle.pbDisplay(_INTL("¡{1} maldice a {2} a través de su oscura alma! ¡Intenta terminar con su vida!",user.pbThis,target.pbThis(true)))
    target.effects[PBEffects::Curse] = true
    user.pbItemHPHealCheck
  end
end
...
#===============================================================================
# Target will lose 1/8 of max HP at end of each round, but 1/4 if type WATER or STEEL (Salt)
#===============================================================================
class PokeBattle_Move_10G < PokeBattle_Move
  def pbEffectAgainstTarget(user,target)
    target.effects[PBEffects::Salted] = true
    @battle.pbDisplay(_INTL("{1} está siendo curado con sal!",target.pbThis))
  end
end
...
# already moved. (Sucker Punch, Thunder Clap)
#===============================================================================
...
class PokeBattle_Move_CF8 < PokeBattle_Move
  def pbEffectAgainstTarget(user, target)
    target.pbCureStatus if target.status == :BURN
  end
end
...
# (Purify)
#===============================================================================
class PokeBattle_Move_CF3 < PokeBattle_HealingMove
  def pbFailsAgainstTarget?(user,target)
...
#===============================================================================
class PokeBattle_Move_CF1 < PokeBattle_StatDownMove
  def initialize(battle,move)
    super
    @statDown = [:DEFENSE,1]
  end
...
#===============================================================================
class PokeBattle_Move_170 < PokeBattle_Move_163
  def initialize(battle,move)
    super
    @calcCategory = 1
  end
...
#===============================================================================
# Power is doubled if the user's last move failed. (Stomping Tantrum, Temper Flare)
#===============================================================================
...
#===============================================================================
class PokeBattle_Move_15B < PokeBattle_ProtectMove
  def initialize(battle,move)
    super
...
#===============================================================================
class PokeBattle_Move_CF5 < PokeBattle_HealingMove
  def pbHealAmount(user)
...
#===============================================================================
class PokeBattle_Move_191 < PokeBattle_FlinchMove
...
#===============================================================================
class PokeBattle_Move_174 < PokeBattle_Move_01F
  def pbMoveFailed?(user, targets)
  ...
  def pbBaseType(user)
    return :DARK if user.form == 1 && GameData::Type.exists?(:DARK) && !user.isSpecies?(:SHARPEDO)
    return @type
  end
end
...
#===============================================================================
class PokeBattle_Move_177 < PokeBattle_MultiStatUpMove
  def initialize(battle,move)
    super
    @statUp = [
...
# (Dragon Darts)
#===============================================================================
class PokeBattle_Move_212 < PokeBattle_Move_0BD
...
class PokeBattle_Move_181 < PokeBattle_Move
  def pbEffectAgainstTarget(user,target)
    ...
    user.effects[PBEffects::JawLock]   = target.index
...
#===============================================================================
class PokeBattle_Move_183 < PokeBattle_Move_02D
  def pbMoveFailed?(user, targets)
  ...
  def pbEffectGeneral(user)
    super                            
    unless user.effects[PBEffects::NoRetreat]     
