...
# Decreases the target's Special Attack by 1 stage.
#===============================================================================
class PokeBattle_Move_04G < PokeBattle_TargetMultiStatDownMove
  def initialize(battle,move)
    super
...
#===============================================================================
# SHADOW MOVE
# Enemy cannot longer scape and target defenses decreases
#===============================================================================
class PokeBattle_Move_04H < PokeBattle_TargetMultiStatDownMove
  ...
  def pbAdditionalEffect(user,target)
    ...
    @battle.pbDisplay(_INTL("{1} ya no puede escapar!",target.pbThis))
  end
end
...
class PokeBattle_Move_065 < PokeBattle_Move
  ...
  def pbFailsAgainstTarget?(user,target)
    ...
    if target.ungainableAbility? ||
       [:POWEROFALCHEMY, :RECEIVER, :TRACE, :WONDERGUARD, :COMMANDER].include?(target.ability_id)
      @battle.pbDisplay(_INTL("But it failed!"))
      return true
    end
    return false
...
#===============================================================================
# Halves the target's current HP. (Nature's Madness, Super Fang, Ruination)
#===============================================================================
