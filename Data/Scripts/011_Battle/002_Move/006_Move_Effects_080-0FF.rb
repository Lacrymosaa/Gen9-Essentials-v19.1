...
def pbHiddenPower(pkmn)
  ...
  if pkmn.is_a?(PokeBattle_Battler)
    iv = pkmn.pokemon.iv
  else
    iv = pkmn.iv
  end
...
#===============================================================================
# This attack is always a critical hit. (Frost Breath, Storm Throw, Flower Trick, Wicked Blow)
#===============================================================================
...
#===============================================================================
# Heals user by 1/2 of its max HP. (Heal Order)
#===============================================================================
...
class PokeBattle_Move_0D8 < PokeBattle_HealingMove
  def pbOnStartUse(user,targets)
    ...
    when :Rain, :HeavyRain, :Sandstorm, :Hail
    ...
    @flingPowers = {
      ...
      100 => [:HARDSTONE,:RAREBONE,
       ...
       30 => [:ABSORBBULB,:ADRENALINEORB,:AMULETCOIN,:BINDINGBAND,:BLACKBELT,
              ...
              :SOULDEW,:SPELLTAG,:TOXICORB,:TWISTEDSPOON,:UPGRADE,:NUNCHAKUS,
              # Healing items
...
#===============================================================================
# User doesnt take recoil damage, but heals and burns: From Mega Mightyena (Silver Blitz)
#===============================================================================
class PokeBattle_Move_0FG < PokeBattle_Move

  def pbMoveFailed?(user,targets)
    echo user.form
    if user.form == 0
      @battle.pbDisplay(_INTL("¡Tu Pokémon no ha megaevolucionado!"))
      @battle.pbDisplay(_INTL("El ataque falló."))
      return true
    end
    return false
  end
